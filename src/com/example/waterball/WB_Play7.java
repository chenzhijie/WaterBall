...
public class WB_Play7 extends CCColorLayer {
	...
	private List<WB_Sprite> _Snow3=new CopyOnWriteArrayList<WB_Sprite>();//雪花3
	private List<WB_Sprite> _Snow2=new CopyOnWriteArrayList<WB_Sprite>();//雪花2
	private List<WB_Sprite> _Snow1=new CopyOnWriteArrayList<WB_Sprite>();//雪花1
	
	
	private List<WB_Sprite> _Ice2=new CopyOnWriteArrayList<WB_Sprite>();//冰2
	private List<WB_Sprite> _Ice1=new CopyOnWriteArrayList<WB_Sprite>();//冰1
...
//	private String _WB_Back_Path3 = "images/playgamebg3.png";//屏幕背景
	...
	private String _Snow3_Path = "images/snow3.png";//小drip
	private String _Snow2_Path = "images/snow2.png";//小drip
	private String _Snow1_Path = "images/snow1.png";//小drip
	private String _Ice2_Path = "images/ice2.png";//小drip
	private String _Ice1_Path = "images/ice1.png";//小drip
...
//	   int randomValue=0;
   ...
   private void AddIce()
   {
	   ...
	   Random rand = new Random();
//	   int randomValue=0;
		int randomValue = rand.nextInt(5);//0-29的随机数
		WB_Sprite wb_drip=new WB_Sprite();
		wb_drip.setClicked_Or(false);
